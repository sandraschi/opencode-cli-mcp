...
const BACKEND_NAME: &str = "opencode-cli-mcp-backend.exe";
const BACKEND_PORT: u16 = 10951;
const BACKEND_TAG: &str = "opencode-cli-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "OPENCODE_CLI_MCP_PORT";
const ENV_HOST: &str = "OPENCODE_CLI_MCP_HOST";
const ENV_TAURI: &str = "OPENCODE_CLI_MCP_TAURI";
